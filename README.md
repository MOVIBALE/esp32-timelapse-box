...
SnapOrca support is maintained as a separate source patch. The complete implementation task is in [the SnapOrca migration prompt](docs/snaporca/esp32-timelapse-box-migration-prompt.md).
